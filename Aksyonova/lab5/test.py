...
class tester(unittest.TestCase):
	...
	def test1(self):
		with open('./Tests/tests/test1.txt', 'r') as file:
			...
			print(line[0])
			print(line[1])
			self.assertIn("Finished right", subprocess.check_output(["./lab5", line[0], line[1]], universal_newlines=True))	
			print("\nOutput:\n")
			print(subprocess.check_output(["./lab5", line[0], line[1]], universal_newlines=True))
