...
class tester(unittest.TestCase):
	...
	def test1(self):
		with open('./Tests/test1.txt', 'r') as file:
			...
			print(l[0])
			print(l[1])
			self.assertIn('Finished successful!', subprocess.check_output(["./lab5", l[0], l[1]], universal_newlines=True))	
			print("\nOutput:\n")
			print(subprocess.check_output(["./lab5", l[0], l[1]], universal_newlines=True))
